          ...
          <div className="text-center mt-20">
            <div className="home-sessions rounded-3xl p-10 shadow-2xl border border-white/20 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button className="cursor-pointer bg-gradient-to-r from-blue-500 to-green-500 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:from-blue-600 hover:to-green-600 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-blue-500/25 flex items-center justify-center gap-3">
